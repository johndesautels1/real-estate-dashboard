...
setPropertyData(prev => ({
  ...
  subdivision: client.subdivision || prev.subdivision
}));
...
// Clear static comparables and replace with client data
setComparables([{
  id: 1,
  address: client.address || 'New Property',
  subdivision: client.subdivision || 'Unknown',
  distance: 'Subject',
  status: 'Subject',
  listPrice: parseInt(client.listPrice) || 0,
  soldPrice: null,
  beds: parseInt(client.bedrooms) || 0,
  baths: parseFloat(client.bathrooms) || 0,
  sqft: parseInt(client.sqft) || 0,
  year: parseInt(client.yearBuilt) || 0,
  condition: client.condition || 'Unknown',
  pricePerSqft: parseInt(client.listPrice) && parseInt(client.sqft) ? 
    Math.round(parseInt(client.listPrice) / parseInt(client.sqft)) : 0,
  daysOnMarket: 0,
  latitude: client.latitude || 27.9778,
  longitude: client.longitude || -82.7264
}]);
